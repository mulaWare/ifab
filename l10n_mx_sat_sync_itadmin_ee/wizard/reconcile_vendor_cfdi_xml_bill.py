...
class ReconcileVendorCfdiXmlBill(models.TransientModel):
    ...
    typo_de_combante = fields.Selection([('I','Facturas de clientes'),('SI', 'Facturas de proveedor'), ('P', 'Pagos de clientes'),('SP', 'Pagos de proveedor'),], string='Tipo de Comprobante')
