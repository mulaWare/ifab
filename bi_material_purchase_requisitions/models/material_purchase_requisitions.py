...
class RequisitionLine(models.Model):
    ...
    location_id = fields.Many2one('stock.location', string='Location', auto_join=True, ondelete='restrict', readonly=True,  default=lambda self: self.env['stock.quant'].search([&,('product_id', '=', self.product_id.id),('location_id.usage','=', 'internal')], limit=1))
