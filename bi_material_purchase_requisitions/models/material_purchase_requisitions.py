...
class RequisitionLine(models.Model):
    ...
    def compute_location(self):
        ...
        if not self.qty_available:
            return res
        location = self.product_id.stock_quant_ids[1].location_id.id
        return location
    ...
    location_id = fields.Many2one('stock.location', string='Location', auto_join=True, ondelete='restrict', readonly=True, domain=[('usage', 'like', 'internal')],related='product_id.location_id')
