...
class RequisitionLine(models.Model):
    ...
    def onchange_product_id(self):
        ...
        self.location_id = self.mapped('product_id.stock_quant_ids').filtered(lambda u: u.product_id.stock_quant_ids.location_id.usage = 'internal').browse()
    ...
    location_id = fields.Many2one('stock.location', string='Location', auto_join=True, ondelete='restrict', readonly=True, required=True)
