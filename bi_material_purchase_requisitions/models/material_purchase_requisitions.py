...
class RequisitionLine(models.Model):
    ...
    location_id = fields.Many2one('stock.location', string='Location', auto_join=True, ondelete='restrict', readonly=True, required=True,default=lambda self: self.env['stock.inventory'].search(['&',('product_id','=',self.product_id.id),('usage','=', 'internal')], limit=1)
