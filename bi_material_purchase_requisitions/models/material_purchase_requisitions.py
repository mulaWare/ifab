...
class MaterialPurchaseRequisition(models.Model):
    ...
    approved_by_stock_id = fields.Many2one('res.users',string="Approved By")
    approved_by_purchase_id = fields.Many2one('res.users',string="Approved By")
    ...
    stock_approval_date = fields.Date(string="Department Approval Date",readonly=True)
    purchase_approval_date = fields.Date(string="Department Approval Date",readonly=True)
