...
class Picking(models.Model):
    ...
    is_verification = fields.Many2one('res.users',string="Verification Responsible",store=True, readonly=True)
    is_date = fields.Date(string="Verification Date",store=True, readonly=True)
